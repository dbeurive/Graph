...
/**
 * This file implements the "Depth First Search" algorithm for undirected graphs.
 */
...
/**
 * Class UndirectedDepthFirstSearch
 *
 * This class implements the "Depth First Search" algorithm for undirected graphs.
 *
 * @package dbeurive\Graph
 */
class UndirectedDepthFirstSearch extends AbstractDepthFirstSearch
{
    use TraitUndirectedGraph;

    /**
     * UndirectedDepthFirstSearch constructor.
